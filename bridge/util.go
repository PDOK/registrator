...
func servicePort(container *dockerapi.Container, port dockerapi.Port, published []dockerapi.PortBinding) ServicePort {
	...
	//With docker compose each composeproject results in a new network.
	//Hence this is not working when docker-compose is used a lot to start containers, see https://docs.docker.com/compose/networking/
